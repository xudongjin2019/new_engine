...
def register_new_usr(name_sign_up: str, email_sign_up: str, depart_sign_up: str, password_sign_up: str) -> None:
    """
    Saves the information of the new user in the _secret_auth.json file.
    """
    new_usr_data = {'username': name_sign_up, 'email': email_sign_up, 'depart': depart_sign_up, 'password': ph.hash(password_sign_up)}
