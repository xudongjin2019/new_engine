...
class __login__:
    ...
    def __init__(self, auth_token: str, company_name: str, width, height, logout_button_name: str = 'Logout', hide_menu_bool: bool = True, hide_footer_bool: bool = True, lottie_url: str = "https://assets8.lottiefiles.com/packages/lf20_ktwnwv5m.json" ):
        """
        Arguments:
        -----------
        1. self
    ...
    def sign_up_widget(self) -> None:
        ...
        with st.form("Sign Up Form"):
            name_sign_up = st.text_input("User Name *", placeholder = 'Please enter your user name')
            unique_username_check = check_unique_usr(name_sign_up)
            ...
            depart_sign_up = st.radio("Department *",('GTE','LSSC-NB','LSSC-DT','LSSC-WS','TJSC-NB','Other') ,horizontal=True)
            ...
            if sign_up_submit_button:
                if valid_name_check == False:
                    ...
                    st.error(f'Sorry, username already exists!')

                elif depart_sign_up == False:
                    st.error("Please select department!")
                    ...
                    if valid_email_check == True:
                        if unique_email_check == True:
                            if unique_username_check == True:
                                register_new_usr(name_sign_up, email_sign_up, depart_sign_up, password_sign_up)
